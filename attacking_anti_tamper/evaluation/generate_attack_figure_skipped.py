...
def generate_graphs(report: Dict[str, List[Dict[str, Any]]], only_failures):
    ...
    for config_name, config in report.items():
        ...
        ax = fig.add_subplot(111,
            ...
            ylabel='number of skipped instructions')
        ...
        # add linear
        ax.plot([0,max_skipped], [0,max_skipped], linestyle='dotted', color='gray', label='linear scaling')

        figures[config_name + '_skipped'] = fig
