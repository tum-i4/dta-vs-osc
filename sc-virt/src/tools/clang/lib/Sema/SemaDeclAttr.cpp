...
static void ProcessDeclAttribute(Sema &S, Scope *scope, Decl *D,
  ...
  case AttributeList::AT_XRayInstrument:
    ...
    break;
  // Sc-Virtualization
  case AttributeList::AT_ScVirtualize:
    handleSimpleAttribute<ScVirtualizeAttr>(S, D, Attr);
    break;
    // Sc-Virtualization - Sensitive
  case AttributeList::AT_ScSensitive:
    handleSimpleAttribute<ScSensitiveAttr>(S, D, Attr);
    break;
  }
}
